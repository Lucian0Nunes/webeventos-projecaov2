...
public class JavaMailApp {
	...
	public void mandaSugestao(final String mensagem, final String usuario) {
		...
		Thread thread = new Thread() {
			public void run() {
				...
				try {
					...
					message.setFrom(new InternetAddress("WebEventosProjecao@gmail.com")); // Remetente

					Address[] toUser = InternetAddress.parse("WebEventosProjecao@gmail.com");

					message.setRecipients(Message.RecipientType.TO, toUser);
					message.setSubject("Sugestao de usu·rio");// Assunto

					message.setText(mensagem +"\n\n "+"Mensagem enviada do  usuario: "+usuario+"\n\n"+ Calendar.getInstance());
